...
#exec TEXTURE IMPORT NAME=CompanionTrigger FILE=Texture\CompanionTrigger.tga FLAGS=2
...
var() CompanionTrigger.NoneFalseTrue HeroFollow_UseDistFromLeadCharForMovement;
...
defaultproperties
{
	bDoActionWhenTriggered=true
	 ...
	 Texture=Texture'CompanionTrigger'
}
