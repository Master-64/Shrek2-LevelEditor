...
var(Mover) float MoverSpringTime;
var(Mover) float MoverMaxAmplitude;
var(Mover) byte MoverFluctuations;
var(Collision) bool bProjTargetMover;
var(Mover) float MoveTimes[24];
var(Mover) float StayOpenTimes[24];
...
defaultproperties
{
     ...
     StayOpenTime=4.00
     bClosed=True
     MoverSpringTime=1.00
     MoverMaxAmplitude=0.10
     MoverFluctuations=1
     bProjTargetMover=True
