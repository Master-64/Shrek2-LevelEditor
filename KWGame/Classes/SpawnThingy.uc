...
#exec TEXTURE IMPORT NAME=SthingE FILE=Texture\SthingE.tga FLAGS=2
...
function bool ObjectShouldBeMoved(Actor SpawnedObject)
{
}

function MoveObject(Actor SpawnedObject)
{
}

function PostTrigger(Actor SpawnedObject)
{
}
