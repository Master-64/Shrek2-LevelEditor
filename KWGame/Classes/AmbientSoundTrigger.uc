...
#exec TEXTURE IMPORT NAME=AmbientSoundTrig FILE=Texture\AmbientSoundTrig.tga FLAGS=2
...
var name OppositeDirectionEvent;
...
defaultproperties
{
     Volume[0]=(Min=0.1,Max=0.5)
     Volume[1]=(Min=0.1,Max=0.5)
     Volume[2]=(Min=0.1,Max=0.5)
     Volume[3]=(Min=0.1,Max=0.5)
     Volume[4]=(Min=0.1,Max=0.5)
     Volume[5]=(Min=0.1,Max=0.5)
     Volume[6]=(Min=0.1,Max=0.5)
     Volume[7]=(Min=0.1,Max=0.5)
     Pitch[0]=(Min=0.5,Max=2)
     Pitch[1]=(Min=0.5,Max=2)
     Pitch[2]=(Min=0.5,Max=2)
     Pitch[3]=(Min=0.5,Max=2)
     Pitch[4]=(Min=0.5,Max=2)
     Pitch[5]=(Min=0.5,Max=2)
     Pitch[6]=(Min=0.5,Max=2)
     Pitch[7]=(Min=0.5,Max=2)
     RepeatTime[0]=(Min=3,Max=6)
     RepeatTime[1]=(Min=3,Max=6)
     RepeatTime[2]=(Min=3,Max=6)
     RepeatTime[3]=(Min=3,Max=6)
     RepeatTime[4]=(Min=3,Max=6)
     RepeatTime[5]=(Min=3,Max=6)
     RepeatTime[6]=(Min=3,Max=6)
     RepeatTime[7]=(Min=3,Max=6)
     fromCamera=(Min=100,Max=200)
	 ...
	 Texture=Texture'AmbientSoundTrig'
}
