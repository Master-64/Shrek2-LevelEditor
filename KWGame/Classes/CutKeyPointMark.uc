...
class CutKeyPointMark extends Keypoint;

#exec TEXTURE IMPORT NAME=CutKeyPointIcon FILE=Texture\CutKeyPointIcon.tga FLAGS=2
...
defaultproperties
{
	 ...
	 Texture=Texture'CutKeyPointIcon'
}
