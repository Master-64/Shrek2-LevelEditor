...
#exec TEXTURE IMPORT NAME=Routesign FILE=Texture\Routesign.tga FLAGS=2
...
function Actor GetFirstGoal()
{
}

function Actor GetLastGoal()
{
}

function Actor GetNextGoal(Actor PrevGoal)
{
}

function Actor FindNextPath(Controller C, Actor LastGoal, optional Actor StartingActor)
{
}

function bool ActorNearSubsequentNodes(Actor TestActor, Actor StartNode, float Distance)
{
}
