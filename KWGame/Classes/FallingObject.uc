...
class FallingObject extends Pawn
  Config(User);

var() name StaticAnimName;
var() name ShakingAnimName;
var() name FallingAnimName;
var() Class<FallingObject> FallingObjectClass;
var Vector Loc;
var Rotator Rot;
var() Class<Emitter> DestroyObjectEmitter;
var() Sound DestroyObjectSound;
var float fCurrTime;
var float fCurrShakingTime;
var array<name> BreakBoneNames;
