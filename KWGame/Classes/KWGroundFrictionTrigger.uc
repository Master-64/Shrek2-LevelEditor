//================================================================================
// KWGroundFrictionTrigger.
//================================================================================

class KWGroundFrictionTrigger extends Trigger;

#exec TEXTURE IMPORT NAME=KWGroundFrictionTrigger FILE=Texture\KWGroundFrictionTrigger.tga FLAGS=2

var() float NewGroundFriction;
enum ETriggerType
{
    TT_PlayerProximity,
    TT_PawnProximity,
...
defaultproperties
{
	 ...
	 Texture=Texture'KWGroundFrictionTrigger'
}
