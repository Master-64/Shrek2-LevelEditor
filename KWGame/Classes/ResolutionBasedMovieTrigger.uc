//================================================================================
// ResolutionBasedMovieTrigger.
//================================================================================

class ResolutionBasedMovieTrigger extends Trigger;

#exec TEXTURE IMPORT NAME=ResolutionBasedMovieTrigger FILE=Texture\ResolutionBasedMovieTrigger.tga FLAGS=2

var() string MovieName;
var() string MovieName512;
var() string MovieName640;
var() string MovieName1024;
enum ETriggerType
{
    TT_PlayerProximity,
    TT_PawnProximity,
...
defaultproperties
{
	 ...
	 Texture=Texture'ResolutionBasedMovieTrigger'
}
