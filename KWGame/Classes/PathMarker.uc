...
function DrawDBug(float ColorMod)
{
}
...
function float GetPctOfPathByLocation(Vector queryPoint)
{
}

function Vector GetPointOnPathFromPct(float Pct)
{
}

function Vector ClosestPointOnPath(Vector queryPoint)
{
}

function Vector GetDirByPct(float Pct)
{
}

function Vector GetDirByLocation(Vector queryPoint)
{
}

function Vector NearestPointOnPerimeter(Vector queryPoint)
{
}
