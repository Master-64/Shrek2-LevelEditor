...
function Init(Actor act, byte A, byte R, byte G, byte B, float fTime, optional KWGame.enumMoveType mtype, optional bool bShouldDestroy)
{
}

function FadeAllActorsBasedOn(Actor mainActor)
{
}

function DestroyAllFadeActorDelegates()
{
}
