...
class EnemySpawnDirector extends Actor
  Placeable;

var() int NumberOfEnemiesTotal;
var() int NumberOfEnemiesAtOnce;
var() name GroupName;
var() float SpawnDelay;
var int intNumTest;
var array<EnemySpawnPoint> SpawnPoint;
var int totalNumSpawned;
var int currentNumSpawned;
var int currentlyActive;
var int currentlySpawning;
