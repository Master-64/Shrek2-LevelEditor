...
class DamagePlayerTrigger extends Trigger;

#exec TEXTURE IMPORT NAME=DamagePlayerTrigger FILE=Texture\DamagePlayerTrigger.tga FLAGS=2
...
defaultproperties
{
	bDoActionWhenTriggered=true
	 ...
	 Texture=Texture'DamagePlayerTrigger'
}
