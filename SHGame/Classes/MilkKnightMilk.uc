...
class MilkKnightMilk extends Projectile;

var() Class<Emitter> fxMilkClass;
var Emitter milkFX;
...
defaultproperties
{
     fxMilkClass=Class'SHGame.Milk_Gun'
     Speed=250.000000
     MaxSpeed=400.000000
     Damage=5.000000
     DamageRadius=100.000000
     MyDamageType=Class'SHGame.CombatDamage'
     SpawnSound=Sound'items.ent_rotten_throw_apple'
     ImpactSound=Sound'items.apple_explode1'
     ExploWallOut=20.000000
     Mesh=SkeletalMesh'EnvAnims.Milk_Bullet'
     SoundVolume=144
}
