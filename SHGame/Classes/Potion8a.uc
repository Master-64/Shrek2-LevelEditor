...
class Potion8a extends Shrk2_Player_FX;

defaultproperties
{
    Begin Object name=SpriteEmitter1 class=SpriteEmitter
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0,Color=(B=255,G=255,R=166,A=0))
        ColorScale(1)=(RelativeTime=1,Color=(B=253,G=228,R=198,A=0))
        FadeOutStartTime=1
        FadeOut=true
        FadeInEndTime=0.5
        FadeIn=true
    ...
    Begin Object name=SpriteEmitter2 class=SpriteEmitter
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0,Color=(B=255,G=199,R=28,A=0))
        ColorScale(1)=(RelativeTime=1,Color=(B=252,G=244,R=226,A=0))
