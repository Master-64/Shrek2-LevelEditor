//================================================================================
// WheelStealerSpawnPoint.
//================================================================================

class WheelStealerSpawnPoint extends Actor
  Placeable;

var() float HeroEscapeDistance;
var Class<WheelStealer> enemyToSpawnClass;
var WheelStealer Enemy;
var WheelStealerSpawnDirector enemyDirector;
var() name GroupName;
...
function spawnEnemies(int N)
{
}

defaultproperties
{
     HeroEscapeDistance=2000.000000
     enemyToSpawnClass=Class'SHGame.WheelStealer'
