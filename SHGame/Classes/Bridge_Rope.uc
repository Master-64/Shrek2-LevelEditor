...
class Bridge_Rope extends Shrk2_Env_FX;
...
defaultproperties
{
    Begin Object name=SpriteEmitter11 class=SpriteEmitter
        ...
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0.000125,Color=(B=18,G=32,R=44,A=0))
        ColorScale(1)=(RelativeTime=0.5,Color=(B=0,G=20,R=89,A=0))
        FadeOut=true
        MaxParticles=8
        ...
        Texture=Texture'Shrek2_EFX.Gen_Particle.smok_ball2'
    ...
    Begin Object name=MeshEmitter1 class=MeshEmitter
        ...
        StartVelocityRange=(X=(Min=-50,Max=50),Y=(Min=-50,Max=50),Z=(Min=50,Max=200))
    end object
