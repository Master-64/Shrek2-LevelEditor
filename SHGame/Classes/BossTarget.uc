...
class BossTarget extends Keypoint;

#exec TEXTURE IMPORT NAME=BossTarget FILE=Texture\BossTarget.tga FLAGS=2

var() string LabelNext;
var() string LabelPrev;
var() bool bStartTarget;
