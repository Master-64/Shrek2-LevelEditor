...
class Pumk_Bang_Giant extends Shrk2_Enemy_FX;
...
defaultproperties
{
    Begin Object name=SpriteEmitter0 class=SpriteEmitter
        ...
        UseSizeScale=true
        StartSizeRange=(X=(Min=250,Max=500),Y=(Min=250,Max=500),Z=(Min=250,Max=500))
        UniformSize=true
        ...
        StartVelocityRange=(X=(Min=10,Max=15),Y=(Min=10,Max=15),Z=(Min=20,Max=30))
    ...
    Begin Object name=MeshEmitter0 class=MeshEmitter
        ...
        StartSizeRange=(X=(Min=2,Max=5),Y=(Min=2,Max=5),Z=(Min=2,Max=5))
        InitialParticlesPerSecond=100
        AutomaticInitialSpawning=false
        Texture=Texture'Shrek2_EFX.Gen_Particle.fire2'
        SecondsBeforeInactive=0
        LifetimeRange=(Min=1.5,Max=2.25)
        StartVelocityRange=(X=(Min=-500,Max=500),Y=(Min=-500,Max=500),Z=(Min=500,Max=900))
    end object
