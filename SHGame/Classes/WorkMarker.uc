...
class WorkMarker extends PathNode;

#exec TEXTURE IMPORT NAME=WorkMarker FILE=Texture\WorkMarker.tga FLAGS=2

var() string WorkAnimName;
var() float WorkTimeMin;
var() float WorkTimeMax;
var(NavigationPoint) bool bNoAutoConnect;
var(NavigationPoint) bool bUseAsRelocationPoint;
var(NavigationPoint) bool bUseScoutExtent;
var(NavigationPoint) bool bDoDynamicCost;
var(NavigationPoint) float fMinTimeBetweenDynamicPathChecks;
var(NavigationPoint) float fMaxRadiusFromNPCForDynamicPathCheck;
var(NavigationPoint) bool bQuerySpecialCost;
var(NavigationPoint) bool bFlyingOnly;
var(NavigationPoint) int FlyingCost;
var(NavigationPoint) bool bGroundOnly;
var(NavigationPoint) int GroundCost;
...
defaultproperties
{
     WorkTimeMin=2.000000
     WorkTimeMax=4.000000
	 bPropagatesSound=True
     bNotBased=True
     bUseAsRelocationPoint=True
     fMinTimeBetweenDynamicPathChecks=1.00
     fMaxRadiusFromNPCForDynamicPathCheck=1000.00
     FlyingCost=10000000
     GroundCost=10000000
     bStatic=True
     bHidden=True
