...
class BoneTestActor extends Actor
  Placeable;
...
var() Texture TextNames[4];
var() Class<Emitter> EmitterNames[4];
var() bool bTrackBones;
var Emitter Effect[4];
var int entries;
const MaxBones= 4;
