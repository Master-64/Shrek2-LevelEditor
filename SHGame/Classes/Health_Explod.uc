...
class Health_Explod extends Shrk2_Pickup_FX;
...
defaultproperties
{
    Begin Object name=SpriteEmitter1 class=SpriteEmitter
        ...
        ColorScale(1)=(RelativeTime=0.2,Color=(B=0,G=0,R=255,A=0))
        ColorScale(2)=(RelativeTime=0.75,Color=(B=0,G=0,R=255,A=255))
        ColorScale(3)=(RelativeTime=0,Color=(B=0,G=0,R=255,A=255))
