//================================================================================
// LeaveBonusLevelTrigger.
//================================================================================

class LeaveBonusLevelTrigger extends Trigger;

#exec TEXTURE IMPORT NAME=LeaveBonusLevelTrigger FILE=Texture\LeaveBonusLevelTrigger.tga FLAGS=2
...
defaultproperties
{
	bDoActionWhenTriggered=true
	 ...
	 Texture=Texture'LeaveBonusLevelTrigger'
}
