...
class Apple_Rot extends Shrk2_Enemy_FX;
...
defaultproperties
{
    Begin Object name=SpriteEmitter6 class=SpriteEmitter
        ...
        Opacity=0.8
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0,Color=(B=0,G=0,R=255,A=255))
        ColorScale(1)=(RelativeTime=0.1,Color=(B=0,G=0,R=128,A=255))
        ColorScale(2)=(RelativeTime=0.8,Color=(B=128,G=255,R=255,A=128))
        ColorScale(3)=(RelativeTime=1,Color=(B=187,G=255,R=255,A=0))
        FadeOut=true
        MaxParticles=8
    ...
    Begin Object name=MeshEmitter4 class=MeshEmitter
        StaticMesh=StaticMesh'Shrek2_EFX_SM.Beanstalk.Apple2_BitShape'
        ...
        StartSizeRange=(X=(Min=1,Max=3),Y=(Min=1,Max=3),Z=(Min=1,Max=3))
