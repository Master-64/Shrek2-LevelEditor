...
class Steed extends ShHeroPawn
  Config(User);

var SteedHelmet SHelmet;
var() Sound SteedFaintSound;
var() Sound SteedFaintDropSound;
...
defaultproperties
{
     ...
     AttackHeight=50.000000
     AttackAngle=60.000000
     WadeAnims(0)="Walk"
     WadeAnims(1)="walkbackward"
     WadeAnims(2)="walkleft"
     WadeAnims(3)="walkright"
     AttackInfo(0)=(AnimName="punch1",StartBoneName="body_l_brow1_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(1)=(AnimName="punch1",StartBoneName="body_l_brow2_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(2)=(AnimName="punch1",StartBoneName="body_r_brow1_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(3)=(AnimName="punch1",StartBoneName="body_r_brow2_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(4)=(AnimName="punch1",StartBoneName="body_nose_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(5)=(AnimName="punch1",StartBoneName="body_head_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(6)=(AnimName="punch1",StartBoneName="body_mane1_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(7)=(AnimName="punch1",StartBoneName="body_mane2_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(8)=(AnimName="punch1",StartBoneName="body_mane3_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(9)=(AnimName="punch1",StartBoneName="body_mane4_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(10)=(AnimName="punch1",StartBoneName="body_neck_joint",EndBoneName=None,StartFrame=1,EndFrame=13)
     AttackInfo(11)=(AnimName="punch3",StartBoneName="body_l_hip_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(12)=(AnimName="punch3",StartBoneName="body_l_thigh_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(13)=(AnimName="punch3",StartBoneName="body_l_knee_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(14)=(AnimName="punch3",StartBoneName="body_l_heel_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(15)=(AnimName="punch3",StartBoneName="body_l_foot_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(16)=(AnimName="punch3",StartBoneName="body_r_hip_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(17)=(AnimName="punch3",StartBoneName="body_r_thigh_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(18)=(AnimName="punch3",StartBoneName="body_r_knee_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(19)=(AnimName="punch3",StartBoneName="body_r_heel_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(20)=(AnimName="punch3",StartBoneName="body_r_foot_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(21)=(AnimName="punch3",StartBoneName="body_tailbase_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(22)=(AnimName="punch3",StartBoneName="body_tail1_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(23)=(AnimName="punch3",StartBoneName="body_tail2_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(24)=(AnimName="punch3",StartBoneName="body_tail3_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(25)=(AnimName="punch3",StartBoneName="body_tail4_joint",EndBoneName=None,StartFrame=1,EndFrame=20)
     AttackInfo(26)=(AnimName="punch2",StartBoneName="body_l_thigh_joint",EndBoneName=None,StartFrame=4,EndFrame=12)
     AttackInfo(27)=(AnimName="punch2",StartBoneName="body_l_knee_joint",EndBoneName=None,StartFrame=4,EndFrame=12)
     AttackInfo(28)=(AnimName="punch2",StartBoneName="body_l_heel_joint",EndBoneName=None,StartFrame=4,EndFrame=12)
     AttackInfo(29)=(AnimName="punch2",StartBoneName="body_l_foot_joint",EndBoneName=None,StartFrame=4,EndFrame=12)
     AttackInfo(30)=(AnimName="punch2",StartBoneName="body_r_thigh_joint",EndBoneName=None,StartFrame=4,EndFrame=12)
     AttackInfo(31)=(AnimName="punch2",StartBoneName="body_r_knee_joint",EndBoneName=None,StartFrame=4,EndFrame=12)
     AttackInfo(32)=(AnimName="punch2",StartBoneName="body_r_heel_joint",EndBoneName=None,StartFrame=4,EndFrame=12)
     AttackInfo(33)=(AnimName="punch2",StartBoneName="body_r_foot_joint",EndBoneName=None,StartFrame=4,EndFrame=12)
     AttackInfo(34)=(AnimName="punch2",StartBoneName="body_head_joint",EndBoneName=None,StartFrame=17,EndFrame=26)
     AttackInfo(35)=(AnimName="runattack",StartBoneName="body_neck_joint",EndBoneName="body_head_joint",StartFrame=6,EndFrame=23)
     AttackInfo(36)=(AnimName="runattack",StartBoneName="body_head_joint",EndBoneName="body_nose_joint",StartFrame=6,EndFrame=23)
     AttackInfo(37)=(AnimName="runattack",StartBoneName="body_head_joint",EndBoneName="body_l_earbase_joint",StartFrame=6,EndFrame=23)
     AttackInfo(38)=(AnimName="runattack",StartBoneName="body_head_joint",EndBoneName="body_r_earbase_joint",StartFrame=6,EndFrame=23)
     AttackInfo(39)=(AnimName="runattack",StartBoneName="body_mane1_joint",EndBoneName=None,StartFrame=6,EndFrame=23)
     AttackInfo(40)=(AnimName="runattack",StartBoneName="body_mane2_joint",EndBoneName=None,StartFrame=6,EndFrame=23)
     AttackInfo(41)=(AnimName="runattack",StartBoneName="body_mane3_joint",EndBoneName=None,StartFrame=6,EndFrame=23)
     AttackInfo(42)=(AnimName="runattack",StartBoneName="body_mane4_joint",EndBoneName=None,StartFrame=6,EndFrame=23)
     AttackInfo(43)=(AnimName="runattack",StartBoneName="body_l_brow1_joint",EndBoneName=None,StartFrame=6,EndFrame=23)
     AttackInfo(44)=(AnimName="runattack",StartBoneName="body_l_brow2_joint",EndBoneName=None,StartFrame=6,EndFrame=23)
     AttackInfo(45)=(AnimName="runattack",StartBoneName="body_r_brow1_joint",EndBoneName=None,StartFrame=6,EndFrame=23)
     AttackInfo(46)=(AnimName="runattack",StartBoneName="body_r_brow2_joint",EndBoneName=None,StartFrame=6,EndFrame=23)
     PunchEmitterClass=Class'SHGame.Punch_Donkey'
     CameraSetStandard=(vLookAtOffset=(X=-35,Y=0,Z=60),fLookAtDistance=130,fLookAtHeight=40,fRotTightness=8,fRotSpeed=8,fMoveTightness=(X=25,Y=40,Z=40),fMoveSpeed=0,fMaxMouseDeltaX=190,fMaxMouseDeltaY=65,fMinPitch=-10000,fMaxPitch=10000)
     ...
     BigClimbStartOffset=85.000000
     BigClimbOffset=67.000000
