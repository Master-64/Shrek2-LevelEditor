...
class Vent_Slime extends Shrk2_Enemy_FX;
...
defaultproperties
{
    Begin Object name=SpriteEmitter0 class=SpriteEmitter
        ...
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0.000125,Color=(B=6,G=204,R=199,A=0))
        ColorScale(1)=(RelativeTime=0.9999,Color=(B=0,G=128,R=0,A=0))
        ...
        StartVelocityRange=(X=(Min=0,Max=0),Y=(Min=600,Max=600),Z=(Min=40,Max=50))
