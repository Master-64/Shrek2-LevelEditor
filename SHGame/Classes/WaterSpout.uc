...
class WaterSpout extends Shrk2_Env_FX;
...
defaultproperties
{
    ...
    Begin Object name=SpriteEmitter1 class=SpriteEmitter
        ...
        FadeOut=true
        MaxParticles=25
        StartLocationOffset=(X=0,Y=0,Z=200)
        SpinParticles=true
        ...
        StartVelocityRange=(X=(Min=-80,Max=80),Y=(Min=-80,Max=80),Z=(Min=340,Max=450))
        WarmupTicksPerSecond=0.8
        RelativeWarmupTime=1
    end object
    ...
    Begin Object name=SpriteEmitter2 class=SpriteEmitter
        ...
        StartVelocityRange=(X=(Min=-20,Max=20),Y=(Min=-20,Max=20),Z=(Min=300,Max=800))
