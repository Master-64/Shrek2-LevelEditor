...
class Poison_Cloud extends Shrk2_Player_FX;
...
defaultproperties
{
    Begin Object name=SpriteEmitter2 class=SpriteEmitter
        ...
        ColorScale(2)=(RelativeTime=0.75,Color=(B=255,G=255,R=255,A=255))
        ColorScale(3)=(RelativeTime=1,Color=(B=255,G=255,R=255,A=0))
