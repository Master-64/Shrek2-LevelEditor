...
class Potion9a extends Shrk2_Player_FX;

defaultproperties
{
    Begin Object name=SpriteEmitter1 class=SpriteEmitter
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0,Color=(B=29,G=23,R=255,A=0))
        ColorScale(1)=(RelativeTime=1,Color=(B=240,G=196,R=255,A=0))
        FadeOutStartTime=1
        FadeOut=true
        FadeInEndTime=0.5
        FadeIn=true
    ...
    Begin Object name=SpriteEmitter2 class=SpriteEmitter
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0,Color=(B=5,G=0,R=196,A=0))
        ColorScale(1)=(RelativeTime=1,Color=(B=72,G=254,R=230,A=0))
