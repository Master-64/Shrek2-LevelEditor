//================================================================================
// WheelStealerSpawnDirector.
//================================================================================

class WheelStealerSpawnDirector extends Actor
  Placeable;

var int NumberOfWheelStealersTotal;
var() int NumberOfWheelStealers;
var() name GroupName;
var int totalNumSpawned;
var int currentNumSpawned;
var int currentlyActive;
var array<WheelStealerSpawnPoint> SpawnPoint;
var array<WheelStealer> stealer;
var array<Vector> standingSpot;
var int Counter;
var int numberOfBandits;
var WheelStealer speakingStealer;
var() array<Material> RandSkins;
var int numReallySpawned;
var Wheel currentWheel;
var() float groupingMin;
var() float groupingMax;
var WheelStealer catcher;
var WheelStealer thrower;
var() array<name> wsTags;
...
function TheWheelIsFree()
{
}

function BanditSpawned()
{
}

function WheelDestroyed()
{
}
...
function MakeStandingSpots()
{
}

function AddWheelStealerToList(WheelStealer ws)
{
}

function FirstTimeAttach()
{
}
...
function Vector ThrowingWheel(WheelStealer t)
{
}

function Vector DesperateThrow(WheelStealer t)
{
}

function ReturnWheelToThrower()
{
}

function WheelCaught()
{
}

function EnemyKilled(WheelStealer corpse)
{
}
...
defaultproperties
{
     ...
     RandSkins(5)=Texture'ShCharacters.wheelbandit'
     RandSkins(6)=Texture'ShCharacters.wheelbandit2'
     RandSkins(7)=Texture'ShCharacters.wheelbandit3'
     RandSkins(8)=Texture'ShCharacters.wheelbandit4'
     RandSkins(9)=Texture'ShCharacters.wheelbandit5'
     RandSkins(10)=Texture'ShCharacters.wheelbandit'
     RandSkins(11)=Texture'ShCharacters.wheelbandit2'
     RandSkins(12)=Texture'ShCharacters.wheelbandit3'
     groupingMin=325.000000
     groupingMax=365.000000
     wsTags(0)="WheelStealer0"
     wsTags(1)="WheelStealer1"
     wsTags(2)="WheelStealer2"
     wsTags(3)="WheelStealer3"
     wsTags(4)="WheelStealer4"
     wsTags(5)="WheelStealer5"
     wsTags(6)="WheelStealer6"
     wsTags(7)="WheelStealer7"
     wsTags(8)="WheelStealer8"
     wsTags(9)="WheelStealer9"
     wsTags(10)="WheelStealer10"
     wsTags(11)="WheelStealer11"
     wsTags(12)="WheelStealer12"
