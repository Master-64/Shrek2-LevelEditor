...
class StaySmallTrigger extends Trigger;

#exec TEXTURE IMPORT NAME=StaySmallTrigger FILE=Texture\StaySmallTrigger.tga FLAGS=2
...
defaultproperties
{
	 ...
	 Texture=Texture'StaySmallTrigger'
}
