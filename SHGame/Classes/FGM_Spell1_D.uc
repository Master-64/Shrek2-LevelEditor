...
class FGM_Spell1_D extends Shrk2_Enemy_FX;
...
defaultproperties
{
    Begin Object name=SpriteEmitter10 class=SpriteEmitter
        ...
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0.000125,Color=(B=245,G=10,R=134,A=0))
        ColorScale(1)=(RelativeTime=0.999,Color=(B=255,G=128,R=255,A=0))
