...
class Potion5a extends Shrk2_Player_FX;
...
defaultproperties
{
    Begin Object name=SpriteEmitter1 class=SpriteEmitter
        ...
        ColorScale(1)=(RelativeTime=1,Color=(B=0,G=255,R=179,A=0))
        FadeOutStartTime=1
        FadeOut=true
        FadeInEndTime=0.5
        FadeIn=true
    ...
    Begin Object name=SpriteEmitter2 class=SpriteEmitter
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0,Color=(B=0,G=255,R=0,A=0))
        ColorScale(1)=(RelativeTime=1,Color=(B=32,G=196,R=219,A=0))
