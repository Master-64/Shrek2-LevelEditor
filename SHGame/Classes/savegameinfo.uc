...
class savegameinfo extends Info
  Config(User);

var config string Save0Date;
var config string Save1Date;
var config string Save2Date;
var config string Save3Date;
var config string Save4Date;
var config string Save5Date;
var config string Save0Name;
var config string Save1Name;
var config string Save2Name;
var config string Save3Name;
var config string Save4Name;
var config string Save5Name;
