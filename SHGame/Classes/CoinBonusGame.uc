...
class CoinBonusGame extends Info
  Placeable;

#exec TEXTURE IMPORT NAME=CoinBonusGame FILE=Texture\CoinBonusGame.tga FLAGS=2

var() array<int> GameTimeLimits;
var() int TimeLimit;
var int coinsinlevel;
var float DialogLength;
var transient int LastPotionSelected;
var narrator thenarrator;
...
function float SayendofgameDialog()
{
}

function float SayCoinBonusDialog()
{
}
...
defaultproperties
{
     ...
     GameTimeLimits(1)=60
     GameTimeLimits(2)=90
     GameTimeLimits(3)=120
	 Texture=Texture'CoinBonusGame'
}
