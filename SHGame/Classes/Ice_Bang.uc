...
class Ice_Bang extends Shrk2_Env_FX;
...
defaultproperties
{
    Begin Object name=SpriteEmitter3 class=SpriteEmitter
        ...
        Opacity=0.45
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0.00125,Color=(B=255,G=247,R=174,A=255))
        ColorScale(1)=(RelativeTime=1,Color=(B=255,G=190,R=125,A=0))
        FadeOut=true
        MaxParticles=8
        ...
        RelativeWarmupTime=0.9
    end object
    Emitters(0)=SpriteEmitter3
    Begin Object name=MeshEmitter0 class=MeshEmitter
        StaticMesh=StaticMesh'Shrek2_EFX_SM.Beanstalk.Ice_Cube'
        RenderTwoSided=true
        ...
        MeshScaleRange=(X=(Min=0.1,Max=0.3),Y=(Min=0.1,Max=0.3),Z=(Min=0.1,Max=0.3))
        ...
        StartVelocityRange=(X=(Min=-120,Max=120),Y=(Min=-120,Max=120),Z=(Min=-250,Max=550))
    end object
