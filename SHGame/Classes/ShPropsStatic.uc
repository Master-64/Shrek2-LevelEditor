...
class ShPropsStatic extends Pawn
  Config(User);

var(Sound) float PitchMin;
var(Sound) float PitchMax;
var() bool bSHPropsStaticCouldBeAttacked;
var() bool bSHPropsStaticGetDamageByExplode;
var() bool bSHPropsStaticWasHitInThisAttack;
var() bool bSHPropsStaticBreakAnyway;
var() ShadowProjector Shadow;
var() bool bDropShadowOnActors;
...
function SHPropsStaticAddShadow()
{
}

function SHPropsStaticRemoveShadow()
{
}

function SHPropsStaticGiveDamageToPlayer(int Damage, Pawn instigatedBy, Vector HitLocation, Vector Momentum, class<DamageType> DamageType)
{
}
