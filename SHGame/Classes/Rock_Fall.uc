...
class Rock_Fall extends Shrk2_Env_FX;

defaultproperties
{
    Begin Object name=SpriteEmitter18 class=SpriteEmitter
        ...
        Texture=Texture'Shrek2_EFX.Gen_Particle.smk2'
        LifetimeRange=(Min=1,Max=2)
        StartVelocityRange=(X=(Min=10,Max=-5),Y=(Min=10,Max=-5),Z=(Min=60,Max=80))
    ...
    Emitters(0)=SpriteEmitter18
    Begin Object name=MeshEmitter2 class=MeshEmitter
        ...
        FadeIn=true
        RespawnDeadParticles=false
        StartLocationOffset=(X=10,Y=-10,Z=0)
        ...
        StartVelocityRange=(X=(Min=-60,Max=60),Y=(Min=-60,Max=60),Z=(Min=0,Max=10))
    end object
