...
class Cloth_Tear extends Shrk2_Env_FX;
...
defaultproperties
{
    Begin Object name=SpriteEmitter7 class=SpriteEmitter
        ...
        Opacity=0.1
        UseColorScale=true
        ColorScale(0)=(RelativeTime=0.05,Color=(B=202,G=255,R=255,A=0))
        ...
        StartSizeRange=(X=(Min=100,Max=140),Y=(Min=100,Max=140),Z=(Min=100,Max=140))
        UniformSize=true
    ...
    Begin Object name=MeshEmitter0 class=MeshEmitter
        StaticMesh=StaticMesh'3_The_Hunt_SM.Fabric_bitShape'
