...
class FatKnightSkirtRight extends Actor;

var Vector SkirtAttachOffset;
var Rotator SkirtAttachRotation;
...
function setSkirtLocation(Vector V)
{
}

function setSkirtRotation(Rotator R)
{
}

defaultproperties
{
     SkirtAttachOffset=(X=-1.000000,Y=1.000000)
     SkirtAttachRotation=(Pitch=32768,Yaw=49152,Roll=49152)
     StaticMesh=StaticMesh'Character_Props.fatk_r_skirt'
